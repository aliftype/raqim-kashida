# Classical Arabic Naskh kashida pattern set, based largely on Benatia’s matrix:
...
# and an empty cell compiles to no rule at all. The drop with run length is
...
# [B06] §3.4 figure 25, the matrix itself (runs of 4+ letters): within each
